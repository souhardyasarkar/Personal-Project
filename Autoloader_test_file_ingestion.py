...
######## Mapping Columns from source to target ###########

df_new = (
    df.withColumnRenamed("User Division ID", "division_id")
      .withColumnRenamed("User Division ", "division_name")
      .withColumnRenamed("Division Parent ID", "parent_division_id")
      .withColumnRenamed("Division Parent ", "parent_division_name")
      .withColumn("update_ts", current_timestamp())
)

######## Filtering ###########

df_new = df_new.filter(col("division_id").isNotNull())
